...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/ecsutil v0.151.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/k8sconfig v0.151.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/metadataproviders v0.151.0
